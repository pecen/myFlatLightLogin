...
{
    /// <summary>
    /// Command without parameter - for simple actions like Save, Close, Refresh
    /// </summary>
    ...
    /// <summary>
    /// Command with typed parameter - for actions needing context like Delete(id), Navigate(page)
    /// </summary>
